# Todo List (from README.md) details.
...
1. DONE: Refactor? (transform hierarchy)
    - Thoughts:
...
1. DONE: Misc logger-related bugfixes.
...
1. Some things I want to create!!!! (script->EnTT ecs, editor improvements, AFA editor/runtime improvements)
...
1. Graphics library procedure abstraction (basic).
...
1. Create Vulkan 1.3 gfx impl; remove OpenGL 4.6 gfx impl.
    - @TODO
